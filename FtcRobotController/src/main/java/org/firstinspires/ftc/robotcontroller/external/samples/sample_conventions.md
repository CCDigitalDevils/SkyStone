...
ccdd.Unused.Hardware:	This is not an actual OpMode, but a helper class that is used to describe
...
* ccdd.Unused.Hardware class names should be constructed as:  ccdd.Unused.Hardware - Robot type
...
With “Sensor” and “ccdd.Unused.Hardware” samples, the code should demonstrate the essential function,
